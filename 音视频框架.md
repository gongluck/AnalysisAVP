...
#调试源码加上--enable-debug
#32位
CC=cl ./configure --prefix=../build/msvc32 --enable-shared --enable-static --host=mingw32
#64位
CC=cl ./configure --prefix=../build/msvc64 --enable-shared --enable-static --host=mingw64
make -j 16
make install
```
 ...
 * @Last Modified time: 2021-05-29 20:00:55
 */
...
```shell
# win32
cmake -S . -B ../build/win32 -G "Visual Studio 16 2019" -A win32 -DBUILD_PROGRAMS=ON -DBUILD_SHARED_LIBS=OFF
cmake --build ../build/win32 --clean-first --config release --target ALL_BUILD
# x64
cmake -S . -B ../build/x64 -G "Visual Studio 16 2019" -A x64 -DBUILD_PROGRAMS=ON -DBUILD_SHARED_LIBS=OFF
